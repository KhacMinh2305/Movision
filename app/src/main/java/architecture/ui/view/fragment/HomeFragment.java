...
public class HomeFragment extends Fragment {
    ...
    private void initGenresRecyclerViews() {
        ...
        binding.userGenresRecyclerView.setAdapter(new HomeGenreAdapter(getContext(), R.layout.user_genre_item, genre -> {
            String link = "movision://discover/quickgenresearch?genre=" + genre.getId();
            NavDeepLinkRequest request = NavDeepLinkRequest.Builder
                    .fromUri(Uri.parse(link))
                    .build();
            NavOptions options = new NavOptions.Builder().setRestoreState(true).build();
            sharedViewModel.setQuickSearchGenre(String.valueOf(genre.getId()));
