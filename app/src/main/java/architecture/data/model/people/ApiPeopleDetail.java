...
public class ApiPeopleDetail {
    ...
    public PeopleDetails toPeopleDetail() {
        return new PeopleDetails(id, name, biography, knownForDepartment, profilePath, birthday, null, placeOfBirth);
    }
}
